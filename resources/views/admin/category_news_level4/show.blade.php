...
@section('content')
  ...
  <section class="content">
    {!! Form::open(['name' => 'form-news-detail', 'route' => ['admin.category_news4.update', $row->id], 'class' => ['form-product-detail'], 'files' => true]) !!}
    @method('PUT')
      <div class="card-footer text-sm sticky-top">
        <button type="submit" name="save" class="btn btn-sm bg-gradient-primary submit-check">
          <i class="far fa-save mr-2"></i>Lưu
        </button>
        <a class="btn btn-sm bg-gradient-danger" href="{{ route('admin.category_news4') }}" title="Thoát">
      ...
      <div class="row">
                ...
                <div class="card-body card-article">
                  <div class="tab-content">
                    <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang">
                      ...
                      @if (config('admin.news.category.category4.desc') === true)
                        <div class="form-group">
                          <label for="desc">Mô tả:</label>
                          <textarea name="description" class="form-control text-sm {{ config('admin.news.category.category4.desc_tiny') === true ? 'tiny' : ''}}" id="desc" cols="30" rows="10" placeholder="Mô tả">{!! $row->desc !!}</textarea>
                        </div>
                      @endif

                      @if (config('admin.news.category.category4.content') === true)
                        <div class="form-group">
                          <label for="content">Nội dung:</label>
                          <textarea name="content" class="form-control text-sm {{ config('admin.news.category.category4.content_tiny') === true ? 'tiny' : ''}}" id="content" cols="30" rows="10" placeholder="Nội dung">{!! $row->content !!}</textarea>
                        </div>
                      @endif
                    </div>
                  </div>
        ...
        <div class="col-xl-4">
          ...
          {{-- Photo 1 --}}
          @if (config('admin.news.category.category4.photo1') === true)
            <div class="card card-primary card-outline text-sm">
              <div class="card-header">
              ...
              <div class="card-body">
                <div class="photoUpload-zone">
                  <div class="photoUpload-detail" id="photoUpload-preview1">
                    @if (!empty($row->photo1))
                      <img class="rounded img-preview img-fluid" src="{{ url("public/upload/category_news4/$row->photo1")  }}" alt="{{ $row->title }}"/>
                      <a class="delete-photo" href="{{ route('admin.category_news4.delete_photo', ['id' => $row->id, 'action' => 'photo1']) }}" style="cursor: pointer" title="Xóa hình ảnh">
                  ...
                  <div class="photoUpload-dimension">
                    {{ config('admin.news.category.category4.thumb1') }}
                  </div>
                </div>
              </div>
            </div>
          ...
          {{-- Photo 2 --}}
          @if (config('admin.news.category.category4.photo2') === true)
            <div class="card card-primary card-outline text-sm">
              <div class="card-header">
              ...
              <div class="card-body">
                <div class="photoUpload-zone">
                  <div class="photoUpload-detail" id="photoUpload-preview2">
                    @if (!empty($row->photo2))
                      <img class="rounded img-preview img-fluid" src="{{ url("public/upload/category_news4/$row->photo2")  }}" alt="{{ $row->title }}"/>
                      <a class="delete-photo" href="{{ route('admin.category_news4.delete_photo', ['id' => $row->id, 'action' => 'photo2']) }}" style="cursor: pointer" title="Xóa hình ảnh">
                        <i class="far fa-trash-alt text-white"></i>
                      </a>
                    @else
                      <img class="rounded img-preview img-fluid" src="{{ url("resources/images/noimage.png")  }}" alt="{{ $row->title }}"/>
                  ...
                  <div class="photoUpload-dimension">
                    {{ config('admin.news.category.category4.thumb2') }}
                  </div>
                </div>
              </div>
            </div>
          ...
          {{-- Photo 3 --}}
          @if (config('admin.news.category.category4.photo3') === true)
            <div class="card card-primary card-outline text-sm">
              <div class="card-header">
              ...
              <div class="card-body">
                <div class="photoUpload-zone">
                  <div class="photoUpload-detail" id="photoUpload-preview3">
                    @if (!empty($row->photo3))
                      <img class="rounded img-preview img-fluid" src="{{ url("public/upload/category_news4/$row->photo3")  }}" alt="{{ $row->title }}"/>
                      <a class="delete-photo" href="{{ route('admin.category_news4.delete_photo', ['id' => $row->id, 'action' => 'photo3']) }}" style="cursor: pointer" title="Xóa hình ảnh">
                        <i class="far fa-trash-alt text-white"></i>
                      </a>
                    @else
                      <img class="rounded img-preview img-fluid" src="{{ url("resources/images/noimage.png") }}" alt="{{ $row->title }}"/>
                  ...
                  <div class="photoUpload-dimension">
                    {{ config('admin.news.category.category4.thumb3') }}
                  </div>
                </div>
              </div>
            </div>
          ...
          {{-- Photo 4 --}}
          @if (config('admin.news.category.category4.photo4') === true)
            <div class="card card-primary card-outline text-sm">
              <div class="card-header">
              ...
              <div class="card-body">
                <div class="photoUpload-zone">
                  <div class="photoUpload-detail" id="photoUpload-preview4">
                    @if (!empty($row->photo4))
                      <img class="rounded img-preview img-fluid" src="{{ url("public/upload/category_news4/$row->photo4")  }}" alt="{{ $row->title }}"/>
                      <a class="delete-photo" href="{{ route('admin.category_news4.delete_photo', ['id' => $row->id, 'action' => 'photo4']) }}" style="cursor: pointer" title="Xóa hình ảnh">
                        <i class="far fa-trash-alt text-white"></i>
                      </a>
                    @else
                      <img class="rounded img-preview img-fluid" src="{{ url("resources/images/noimage.png")  }}" alt="{{ $row->title }}"/>
                  ...
                  <div class="photoUpload-dimension">
                    {{ config('admin.news.category.category4.thumb4') }}
                  </div>
                </div>
              </div>
            </div>
      ...
      {{-- SEO --}}
      @if (config('admin.news.category.category4.seo') === true)
        <div class="card card-primary card-outline text-sm">
          <div class="card-header">
                ...
                <div class="card-body">
                  <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                    <div class="tab-pane fade show active" id="tabs-seolang-vi" role="tabpanel" aria-labelledby="tabs-lang">
                      ...
                      @if (config('admin.news.category.category4.seo_title') === true)
                        <div class="form-group">
                          <div class="label-seo">
                      ...
                      @if (config('admin.news.category.category4.seo_keyword') === true)
                        <div class="form-group">
                          <div class="label-seo">
                      ...
                      @if (config('admin.news.category.category4.seo_desc') === true)
                        <div class="form-group">
                          <div class="label-seo">
