                    ...
                    <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang">
                      ...
                      @if (config('admin.product.content') === true)
                        <div class="form-group">
                          ...
                          <textarea name="content" class="form-control text-sm" id="content" cols="30" rows="10" placeholder="Nội dung"></textarea>
                        </div>
                      @endif
                    </div>
                  </div>
            ...
            <div class="card-body">
              <div class="form-group-category row">
                <div class="form-group col-xl-6 col-sm-4">
                  <label class="d-block" for="id_parent1">Danh mục cấp 1:</label>
            ...
            <div class="card-body">
              <div class="photoUpload-zone">
                <div class="photoUpload-detail" id="photoUpload-preview">
                  <img class="rounded" src="http://localhost/euphoria_pdo/public/images/noimage.png" alt=" Alt Photo"/>
                </div>
                ...
                <div class="photoUpload-dimension">
                  Width: 282 px - Height: 370 px (.jpg|.gif|.png|.jpeg|.gif)
                </div>
              </div>
            </div>
          </div>
