  ...
  <section class="content">
    <form action="" class="validation-form" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col-xl-8">
          {{-- Slug --}}
          @if (config('admin.post.criteria.slug') === true)
                    ...
                    <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel" aria-labelledby="tabs-lang">
                      ...
                      @if (config('admin.post.criteria.desc') === true)
                        <div class="form-group">
                          ...
                          <textarea name="description" class="form-control text-sm" id="desc" cols="30" rows="10" placeholder="Mô tả"></textarea>
                        </div>
                      @endif
                    </div>
                  </div>
        ...
        <div class="col-xl-4">
          ...
          {{-- Photo 1 --}}
          @if (config('admin.post.criteria.photo1') === true)
            <div class="card card-primary card-outline text-sm">
              <div class="card-header">
              ...
              <div class="card-body">
                <div class="photoUpload-zone">
                  ...
                  <div class="photoUpload-dimension">
                    {{ config('admin.post.criteria.thumb1') }}
                  </div>
                </div>
              </div>
            </div>
          ...
          {{-- Photo 2 --}}
          @if (config('admin.post.criteria.photo2') === true)
            <div class="card card-primary card-outline text-sm">
              <div class="card-header">
              ...
              <div class="card-body">
                <div class="photoUpload-zone">
                  ...
                  <div class="photoUpload-dimension">
                    {{ config('admin.post.criteria.thumb2') }}
                  </div>
                </div>
              </div>
            </div>
          ...
          {{-- Photo 3 --}}
          @if (config('admin.post.criteria.photo3') === true)
            <div class="card card-primary card-outline text-sm">
              <div class="card-header">
              ...
              <div class="card-body">
                <div class="photoUpload-zone">
                  ...
                  <div class="photoUpload-dimension">
                    {{ config('admin.post.criteria.thumb3') }}
                  </div>
                </div>
              </div>
            </div>
          ...
          {{-- Photo 4 --}}
          @if (config('admin.post.criteria.photo4') === true)
            <div class="card card-primary card-outline text-sm">
              <div class="card-header">
              ...
              <div class="card-body">
                <div class="photoUpload-zone">
                  ...
                  <div class="photoUpload-dimension">
                    {{ config('admin.post.criteria.thumb4') }}
                  </div>
                </div>
              </div>
            </div>
      ...
      {{-- SEO --}}
      @if (config('admin.post.criteria.seo') === true)
        <div class="card card-primary card-outline text-sm">
          <div class="card-header">
