                ...
                @foreach ($rows as $key => $row)
                  <tr>
                    ...
                    @foreach (config('admin.news.status') as $key => $value)
                      <td class="align-middle text-center">
                        <div class="custom-control custom-checkbox">
                          ...
                          @endphp
                          <input type="checkbox" id="update-status-{{$key}}" class="update-status custom-control-input" name="{{ $key }}" data-id="{{ $row->id }}" data-url="{{route('admin.news.update_status')}}" {{ in_array($key, $status) ? 'checked' : '' }} />
                    ...
                    <td class="align-middle text-center text-md text-nowrap">
                      ...
                      @if(config('admin.news.copy') === true)
