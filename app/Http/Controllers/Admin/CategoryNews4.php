...
class CategoryNews4 extends Controller
{
  ...
  public function __construct()
  {
    ...
    $this->width1 = config("admin.news.category.category4.width1");
    $this->width2 = config("admin.news.category.category4.width2");
    $this->width3 = config("admin.news.category.category4.width3");
    $this->width4 = config("admin.news.category.category4.width4");
