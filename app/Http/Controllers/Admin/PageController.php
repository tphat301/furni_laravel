...
class PageController extends Controller
{
  ...
  {
    session(['module_active' => 'about_create']);
    $type = config('admin.page.about.type');
  ...
  {
    session(['module_active' => 'footer_create']);
    $type = config('admin.page.footer.type');
    $row = Page::where('type', $type)->first();
    return view('admin.page.index', compact('row', 'type'));
  }

  /*Contact*/
  public function contact()
  {
    session(['module_active' => 'contact_create']);
    $type = config('admin.page.contact.type');
    $row = Page::where('type', $type)->first();
    return view('admin.page.index', compact('row', 'type'));
  }
  ...
  {
    session(['module_active' => 'copyright_create']);
    $type = config('admin.page.copyright.type');
    $row = Page::where('type', $type)->first();
    return view('admin.page.index', compact('row', 'type'));
  }
  ...
  public function deletePhoto(Request $request)
  {
    ...
    $direct = "admin.page." . $request->type;
