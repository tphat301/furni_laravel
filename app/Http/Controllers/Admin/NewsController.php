...
class NewsController extends Controller
{
  ...
  public function __construct()
  {
    ...
    $this->widthGallery = config("admin.news.gallery.width");
    $this->width1 = config("admin.news.width1");
    $this->width2 = config("admin.news.width2");
    $this->width3 = config("admin.news.width3");
    $this->width4 = config("admin.news.width4");
