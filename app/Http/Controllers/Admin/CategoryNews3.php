...
class CategoryNews3 extends Controller
{
  ...
  public function __construct()
  {
    ...
    $this->with1 = config("admin.news.category.category3.width1");
    $this->with2 = config("admin.news.category.category3.width2");
    $this->with3 = config("admin.news.category.category3.width3");
    $this->with4 = config("admin.news.category.category3.width4");
  ...
  public function delete($id, $hash)
  {
    ...
    CategoryNews::where('type', $this->typeCategory3)->where('hash', $hash)->delete($id);
    $seo->delete();
