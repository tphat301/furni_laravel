...
class CategoryProduct3 extends Controller
{
  ...
  public function __construct()
  {
    ...
    $this->with1 = config("admin.product.category.category3.width1");
    $this->with2 = config("admin.product.category.category3.width2");
    $this->with3 = config("admin.product.category.category3.width3");
    $this->with4 = config("admin.product.category.category3.width4");
