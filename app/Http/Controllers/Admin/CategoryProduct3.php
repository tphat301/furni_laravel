...
class CategoryProduct3 extends Controller
{
  ...
  public function __construct()
  {
    ...
    $this->numberPerPage = config('admin.product.category.category3.number_per_page');
    $this->uploadCategoryProduct = "public/upload/category_product3";
    $this->width1 = config("admin.product.category.category3.width1");
    $this->width2 = config("admin.product.category.category3.width2");
    $this->width3 = config("admin.product.category.category3.width3");
    $this->width4 = config("admin.product.category.category3.width4");
    $this->height1 = config("admin.product.category.category3.height1");
    $this->height2 = config("admin.product.category.category3.height2");
    $this->height3 = config("admin.product.category.category3.height3");
    $this->height4 = config("admin.product.category.category3.height4");
  }
  ...
  public function index(Request $request)
  {
    ...
    if ($request->input('keyword')) {
      $rows = CategoryProduct::where("title", "LIKE", "%{$request->input('keyword')}%")->where('type', $this->typeCategory3)->where('level', 3)->orderBy('num', 'ASC')->orderBy('id', 'ASC')->paginate($this->numberPerPage);
    } else {
      $rows = CategoryProduct::where('type', $this->typeCategory3)->where('level', 3)->orderBy('num', 'ASC')->orderBy('id', 'ASC')->paginate($this->numberPerPage);
    }
