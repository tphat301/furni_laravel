...
class CategoryProduct4 extends Controller
{
  ...
  public function __construct()
  {
    ...
    $this->numberPerPage = config('admin.product.category.category4.number_per_page');
    $this->uploadCategoryProduct = "public/upload/category_product4";
    $this->width1 = config("admin.product.category.category4.width1");
    $this->width2 = config("admin.product.category.category4.width2");
    $this->width3 = config("admin.product.category.category4.width3");
    $this->width4 = config("admin.product.category.category4.width4");
    $this->height1 = config("admin.product.category.category4.height1");
    $this->height2 = config("admin.product.category.category4.height2");
    $this->height3 = config("admin.product.category.category4.height3");
    $this->height4 = config("admin.product.category.category4.height4");
  }
  ...
  public function index(Request $request)
  {
    ...
    if ($request->input('keyword')) {
      $rows = CategoryProduct::where("title", "LIKE", "%{$request->input('keyword')}%")->where('type', $this->typeCategory4)->where('level', 4)->orderBy('num', 'ASC')->orderBy('id', 'ASC')->paginate($this->numberPerPage);
    } else {
      $rows = CategoryProduct::where('type', $this->typeCategory4)->where('level', 4)->orderBy('num', 'ASC')->orderBy('id', 'ASC')->paginate($this->numberPerPage);
    }
  ...
  public function delete($id, $hash)
  {
    ...
    CategoryProduct::where('type', $this->typeCategory4)->where('hash', $hash)->delete($id);
    $seo->delete();
